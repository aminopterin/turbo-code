...
const double epsl =std::numeric_limits<double>::epsilon();// smallest step of double around 1.0
const double maxExpArg =std::log( posInf );
const double minExpArg =std::log( epsl );
const double maxLogArg =std::exp( posInf );
const double minLogArg =std::exp( negInf );
const double pi =3.14159265358979323846;// \pi

// simulation-method related:
const std::size_t len_k =40;//first dimension of interleaving square
const std::size_t len_l =30;//second dimension of interleaving square
...
const std::size_t init[] ={ 1, 2, 3, 4, 5, 6, 7, 8, 9  };// XXX
